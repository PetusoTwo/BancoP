...
public class loginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Ingresar.setBackground(new java.awt.Color(0, 51, 54));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(134, 134, 134)
                                .addComponent(Ingresar, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void IngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IngresarActionPerformed
        if (user.getText().equals("admin") && password.getText().equals("admin")) {
            ...
            JOptionPane.showMessageDialog(null, "Credenciales incorrectas", "Banco Perú", 2);
            user.setText("");
            password.setText("");
        }
